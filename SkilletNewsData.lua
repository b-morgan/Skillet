...
Skillet.NewsData = {
	...
	{	version = "5.59",
		data = {
			{	name = "Changes",
				data = {
					{ header = "UI", body = "Fix DA.DEBUG in .xml files" },
				},
			},
		},
	},
	{	version = "5.58",
		data = {
			{	name = "Changes",
				data = {
					{ header = "Packaging", body = "Commit changes before releasing" },
				},
			},
		},
	},
	{	version = "5.57",
		data = {
			{	name = "Changes",
				data = {
					{ header = "TOC", body = "Update TOC for 120100" },
					{ header = "Misc", body = "Add secret protection to IsNotSupportedFollower" },
				},
			},
		},
	},
	{	version = "5.56",
		data = {
			{	name = "Changes",
				data = {
					{ header = "TOC", body = "Update TOC to 120007" },
					{ header = "Plugins", body = "Update Auctionator plugin" },
				},
			},
		},
	},
	{	version = "5.55",
		data = {
			{	name = "Changes",
				data = {
					{ header = "Filters", body = "Add First Craft Bonus filter" },
					{ header = "Plugins", body = "Update CanIMogIt plugin" },
				},
			},
		},
	},
		...
		data = {
			{	name = "Changes",
				data = {
					...
					{ header = "TOC", body = "Update TOC to 120005" },
				},
			},
		},
	},
	...
	{	version = "5.52",
		data = {
			{	name = "Changes",
				data = {
					{ header = "Crafting", body = "Add optional currency reagent" },
				},
			},
		},
	},
	{	version = "5.51",
		data = {
			{	name = "Changes",
				data = {
					{ header = "Crafting", body = "Remove broken option" },
					{ header = "Options", body = "Add /skillet version" },
				},
			},
		},
	},
