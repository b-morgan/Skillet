...
function Skillet:GetInventory(player, reagentID)
	if player and reagentID then
		if self.db.realm.inventoryData[player] and self.db.realm.inventoryData[player][reagentID] and type(self.db.realm.inventoryData[player][reagentID]) == "string" then
